...
function Header() {
  ...
  return (
    <div
      className={` h-[100dvh] w-full mx-auto bg-cover bg-center bg-[linear-gradient(to_right_bottom,rgba(44,61,79,0.7),rgba(20,28,36,0.7)),url('/public/images/kaabaSM.jpg')] mix-blend-difference overflow-hidden`}
    >
      <NavbarDesktop />
  ...
  return (
    ...
    <div className=" w-full h-full mx-auto flex flex-col items-center justify-around overflow-hidden ">
      ...
      <div className="  flex flex-col items-center ">
        <p className=" mx-auto text-primary-50 text-[clamp(1.3rem,0.8333rem+2.0741vw,2rem)] font-semibold opacity-80">
          {" "}
